...
![Aaron Conway](https://aaronconway.dev/images/bio-pic-small.png){width=80%}


Contact Info {#contact}
--------------------------------------------------------------------------------

- <i class="fa fa-envelope"></i> aaron.conway@utoronto.ca
- <i class="fa fa-github"></i> [github.com/awconway](https://github.com/awconway)
 - <i class="fa fa-github"></i> @aw_conway
